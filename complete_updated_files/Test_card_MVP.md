...
### Hypothesis
“New users will click a quick-action if they clearly understand its purpose.”
> “I tried tapping the button but wasn't sure what would happen next.” – Participant 5

### Experiment Design
Deploy quick-action UI to 200 new sign-ups; instrument analytics for each button click; record device type.
...
- **Risk:** Label confusion reduces clicks.
  **Mitigation:** Conduct quick A/B test of labels (“Shop Deals” vs. “Browse Sales”) first.
